<?php
    ...
    $bet->setID($_SESSION['id']);
    $bets = $bet->getUserBets();
?>
...
<html lang="pt-BR">
    ...
    <head>
        ...
        <title> Bichano's | Minhas Apostas </title>
    ...
    <body>
        ...
        <div class="content-container" style="margin: 0 auto; text-align: center; max-width: 1300px;">
            <br><br><br>
            <h1 style="font-weight: bold; color: #0074D9;">MINHAS APOSTAS</h1>
            <br><br>
                ...
                <tbody>
                    ...
                    <?php foreach ($bets as $bet): ?>
                        <tr>
                            ...
                            <td><?php echo $bet['animal_id']; ?></td>
                            <td><?php echo $bet['contest_id']; ?></td>
                            <td><?php echo $bet['value']; ?></td>
